...
**Telegram реализовано 30.08.2026, ждёт живого деплоя.** Живая разведка
...
**Честно не проверено**: `helm-control/__init__.py` целиком untestable
локально (вне пакета `helm_core`, вне pytest) — первая проверка только
живым деплоем на 185.250.44.137.
