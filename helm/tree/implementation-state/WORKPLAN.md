...
## Текущая фаза: **Milestone A закрыт целиком.** Milestone B: Panel auth **закрыт**, n8n (P6) и Forgejo (P6.5) **подняты и подтверждены живьём**. MAX (P7) **отложен** — требует нового Hermes-side plugin, которого ещё нет. Дальше: миграция 6 репозиториев в Forgejo, первый n8n-коннектор, либо проектирование MAX/Hermes.
...
## MAX (P7) — отложено 29.08.2026: требует нового Hermes-side plugin
