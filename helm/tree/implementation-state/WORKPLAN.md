...
**Две доработки по итогам живого использования (написаны и
протестированы локально, ЕЩЁ НЕ ЗАДЕПЛОЕНЫ)**: владелец опробовал
диалог сразу после деплоя MAX-стороны и попросил (1) уведомление по
факту завершения асинхронного разбора — диалог стал ТРЁХшаговым, не
...
тестов, 203 всего зелёных (было 192).
