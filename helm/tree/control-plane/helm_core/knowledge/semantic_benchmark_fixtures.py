...
GOLDEN_CASES: tuple[GoldenCase, ...] = (
    ...
    GoldenCase(
        ...
        domain="personal",
        text="Сегодня обычный день, ничего примечательного не произошло.",
    ...
    GoldenCase(
        ...
        notes=(
            "Сущность есть, атомов о ней быть не должно — в тексте нет "
            "утверждений о том, что этот человек сделал."
        ),
    ),
    GoldenCase(
