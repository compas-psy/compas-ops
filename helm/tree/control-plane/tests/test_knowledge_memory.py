...
@pytest.mark.parametrize("text,expected", [
    ...
    # Служебное «что» после команды — часть команды, не факта: живая
    # голосовая заметка 07.09.2026 иначе легла в память как «что я живу
    # на улице Ландышева…» и таким же обрывком возвращалась в ответе.
    ("Запомни, что меня зовут Илья Мартынов", "меня зовут Илья Мартынов"),
    ("Не забудь, что завтра приём", "завтра приём"),
