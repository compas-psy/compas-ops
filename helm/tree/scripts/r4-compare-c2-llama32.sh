#!/bin/bash
# HELM v4.0 RESCUE · R4.6.D candidate 1/3 — llama3.2:3b (Meta, отдельная
# линейка от Qwen/Alibaba и Gemma/Google, уже испытанных в R4).
#
...
sudo docker compose exec -T ollama ollama pull llama3.2:3b
