# Ранбук: ввод канала MAX (ТЗ §10, ADR-014)

**Устарел, заменён `BATCH-01.md`** (шаги 1–3 которого включают
содержимое этого файла и добавляют доставку кода). Блок 1 «разведка
Hermes» ниже к тому же устарел содержательно: разведка нашла, что
план «написать плагин Hermes» был не нужен — см.
`docs/adr/ADR-014-max-responses-api.md` и `hermes-enable-runbook.md`.
Файл оставлен как исторический протокол, не как актуальная инструкция.
