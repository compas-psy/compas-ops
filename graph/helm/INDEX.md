...
Тем в индексе: 175. Полные связи и провенанс — `graphify explain "<id>" --graph graph/ops/graph.json`.
...
- `§10.2` — `helm/tree/compose/docker-compose.yml`, `helm/tree/control-plane/helm_core/api/hooks.py`, `helm/tree/control-plane/helm_core/dispatch.py`, `helm/tree/control-plane/helm_core/hermes_bridge.py`, `helm/tree/control-plane/helm_core/ingest.py`, `helm/tree/control-plane/helm_core/knowledge/probe.py` (+9)
...
- `§4.1` — `helm/PLAN_HELM_v3.3.md`, `helm/tree/compose/docker-compose.yml`, `helm/tree/docs/adr/ADR-025-hybrid-retrieval.md`, `helm/tree/docs/adr/ADR-101-timezone-moscow.md`
...
- `§5.1` — `helm/tree/control-plane/helm_core/knowledge/chat_intake.py`, `helm/tree/scripts/knowledge-probe-smoke-test.sh`
- `§5.2` — `helm/tree/control-plane/helm_core/api/panel.py`, `helm/tree/control-plane/helm_core/knowledge/chat_intake.py`, `helm/tree/docs/adr/ADR-014-max-responses-api.md`, `helm/tree/docs/adr/ADR-021-gigaam-voice-pipeline.md`, `helm/tree/implementation-state/V3.8-DELTA.md`
- `§5.4` — `helm/PLAN_HELM_v3.3.md`, `helm/tree/implementation-state/ROADMAP-TO-DONE.md`, `helm/tree/implementation-state/WORKPLAN.md`, `helm/tree/scripts/ci-deploy-setup.md`
...
- `§5.7` — `helm/PLAN_HELM_v3.3.md`
- `§6.1` — `helm/PLAN_HELM_v3.3.md`, `helm/tree/panel/README.md`
...
- `§7.2` — `helm/PLAN_HELM_v3.3.md`, `helm/tree/control-plane/helm_core/approvals/service.py`, `helm/tree/control-plane/helm_core/models/base.py`, `helm/tree/control-plane/helm_core/models/tables.py`, `helm/tree/control-plane/helm_core/outbox.py`
...
- `§9.3` — `helm/tree/control-plane/helm_core/api/internal.py`, `helm/tree/control-plane/helm_core/ingest.py`, `helm/tree/control-plane/tests/test_api.py`, `helm/tree/hermes/plugins/helm-control/__init__.py`, `helm/tree/hermes/plugins/helm-control/plugin.yaml`, `helm/tree/implementation-state/V3.4-DELTA.md` (+1)
...
- `F-260829-10` — `helm/tree/scripts/v37-v38-deploy-runbook.md`
...
- `F-260831-07` — `helm/tree/implementation-state/ROADMAP-TO-DONE.md`
