...
Тем в индексе: 191. Полные связи и провенанс — `graphify explain "<id>" --graph graph/ops/graph.json`.
...
- `§10.2` — `helm/tree/compose/docker-compose.yml`, `helm/tree/control-plane/helm_core/api/hooks.py`, `helm/tree/control-plane/helm_core/dispatch.py`, `helm/tree/control-plane/helm_core/hermes_bridge.py`, `helm/tree/control-plane/helm_core/ingest.py`, `helm/tree/control-plane/helm_core/knowledge/probe.py` (+11)
...
- `§5.4` — `helm/PLAN_HELM_v3.3.md`, `helm/tree/docs/handoff/SECRETS_MAP.md`, `helm/tree/implementation-state/ROADMAP-TO-DONE.md`, `helm/tree/implementation-state/WORKPLAN.md`, `helm/tree/scripts/ci-deploy-setup.md`
...
- `§9.3` — `helm/tree/control-plane/helm_core/api/internal.py`, `helm/tree/control-plane/helm_core/ingest.py`, `helm/tree/control-plane/tests/test_api.py`, `helm/tree/docs/adr/ADR-013-telegram-pre-dispatch-gate.md`, `helm/tree/hermes/plugins/helm-control/__init__.py`, `helm/tree/hermes/plugins/helm-control/plugin.yaml` (+2)
